...
const Logo = ({ className }: { className: string }) => (
  <svg
    ...
    className={className}
  >
    <ellipse cx="996" cy="204" rx="60" ry="60" fill="#FA541C"></ellipse>
    <path
      fill="currentColor"
...
export function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm shadow-md pl-16 pr-16">
      <section className="flex flex-row justify-between items-center p-4">
        <Logo className="lg:w-[5%] w-20" />
        <NavbarSheet />
